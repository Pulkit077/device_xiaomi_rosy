...
#define LOG_TAG "android.hardware.power-service.rosy-libperfmgr"
...
int main() {
    ...
    LOG(INFO) << "Rosy Power HAL AIDL Service with Extension is starting with config: "
              << config_path;
    ...
    LOG(INFO) << "Rosy Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Rosy Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
